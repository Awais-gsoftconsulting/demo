...
const Register = () => {
  ...
  return (
   ...
   <h1 align='center'>CREATE AN ACCOUNT</h1>
    ...
    <input type="text"  name="name" value={input.name} onChange={(e)=>setinput({...input,[e.target.name]:e.target.value})} class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
    </div>
  ...
  <label class='ms-3'> Have Already an Account</label> <span> <Link to='/login'>Login here</Link></span>
